...
if __name__=="__main__":
    ...
    indeks = int(input())
    testCase = train_data[indeks]

    klasa = c.classifyDocument(testCase[1])

    print("Pozitivni primeri: ", int(c.getCategoryCount('positive')), "Negativni primeri: ", int(c.getCategoryCount('negative')))
    print("Index:", indeks, ",Tocna klasa:", testCase[0], ",Predvidena:", klasa, ",Sozdrzina:", testCase[1])
