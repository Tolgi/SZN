...
if __name__ == "__main__":
    ...
    trainClassifier(cl1, train_data)
    trainClassifier(cl2, train_data)
    recenica = input()
    klasa1 = cl1.classifyDocument(recenica)
    klasa2 = cl2.classifyDocument(recenica)

    verojatnost1 = cl1.getCategoryProbabilityForDocument(recenica, klasa1)
    verojatnost2 = cl2.getCategoryProbabilityForDocument(recenica, klasa2)

    print(klasa1, round(math.log(verojatnost1, 2), 4))
    print(klasa2, round(math.log(verojatnost2, 2), 4))
